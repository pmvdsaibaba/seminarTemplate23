%!TEX root=../main.tex
\section{The Complexities of Healing in Secure Group Messaging: Why Cross-Group Effects Matter}
\label{sec:USENIX:CreHalKoh21}
(Fischer, Lukas, \cite{USENIX:CreHalKoh21,EPRINT:CreHalKoh19})
