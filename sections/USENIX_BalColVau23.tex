%!TEX root=../main.tex
\section{Cryptographic Administration for Secure Group Messaging}
\label{sec:USENIX:BalColVau23}
(Gnagniko, Koffi Tino, \cite{USENIX:BalColVau23,EPRINT:BalColVau22})
