%!TEX root=../main.tex
\section{Device-Oriented Group Messaging: A Formal Cryptographic Analysis of Matrix' Core}
\label{sec:SP:AlbDowJon23}
(Schonecke, Alessia, \cite{SP:AlbDowJon24,EPRINT:AlbDowJon23})
