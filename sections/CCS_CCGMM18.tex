%!TEX root=../main.tex
\section{On Ends-to-Ends Encryption: Asynchronous Group Messaging with Strong Security Guarantees}
\label{sec:CCS:CCGMM18}
(Gnagniko, Koffi Tino, \cite{CCS:CCGMM18,EPRINT:CCGMM17})
