%!TEX root=../main.tex
\section{Key Agreement for Decentralized Secure Group Messaging with Strong Security Guarantees}
\label{sec:CCS:WKHB21}
(Schindler, Marco, \cite{CCS:WKHB21,EPRINT:WKHB20})
