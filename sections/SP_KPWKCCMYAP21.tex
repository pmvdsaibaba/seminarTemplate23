%!TEX root=../main.tex
\section{Keep the Dirt: Tainted TreeKEM, Adaptively and Actively Secure Continuous Group Key Agreement}
\label{sec:SP:KPWKCCMYAP21}
(Russo, Tizian, \cite{SP:KPWKCCMYAP21,EPRINT:ACCKKMPPWY19})
